...
export default function PageHeader({
  ...
  return (
    <>
      ...
      <div className={`sticky top-0 z-[48] bg-slate-50/95 backdrop-blur-md -mx-12 px-12 py-5 border-b border-slate-200/50 flex flex-wrap lg:flex-nowrap lg:items-center justify-between gap-y-4 gap-x-6 ${compact ? 'mb-2' : 'mb-8'} transition-all duration-300`}>
