...
async function analyzeBingoCards() {
    try {
        ...
        // Map Key: "n1,n2,n3..." (ordenados)
        // Map Value: Array de { bingoCardNumber, setNumber }
        ...
        bingoCards.forEach(card => {
            ...
            card.cardSets.forEach(set => {
                ...
                if (uniqueNumbers.size !== numbers.length) {
                    // Encontrar cuáles se repiten para informar mejor
                    const seen = new Set();
                ...
                // Ordenamos los números para que la comparación sea independiente del orden
